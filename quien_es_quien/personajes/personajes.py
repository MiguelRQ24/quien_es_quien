...
personajes = {
    ...
    "claire": ["pelo naranja", "nariz pequeña", "boca pequeña", "ojos castaños", "sombrero de flores", "pendientes"],
...
class robert(rx.State):
    ...
    ATRIBUTOS = ("pelo marron", "nariz grande", "boca grande", "ojos azules", "mofletes colorados", "aspecto triste")
